const games = {
    "the legend of zelda: breath of the wild": {
      keywords: [
        ...
        "fantasy", "shrines", "weapons", "crafting", "nintendo", "zelda", "2017", "legend", "zelda", "breath", "wild"
      ]
    },
    "minecraft": {
      keywords: [
        ...
        "bedrock", "notch", "herobrine", "pickaxe", "enderman", "stone", "2009", "minecraft"
      ]
    },
    "wii sports": {
      keywords: [
        ...
        "single player", "fitness", "meme", "music", "wii sports", "wii", "sports"
      ]
    },
    "fortnite": {
      keywords: [
    ...
    "the witcher 3: wild hunt": {
      keywords: [
        "open world", "rpg", "story-driven", "fantasy", "choices", "monsters",
        "quests", "characters", "mature", "geralt", "white hair", "past",
        "witcher", "hunt", "horse", "prophecy", "swords", "fighting", "2015", 
        "the witcher 3: wild hunt", "the witcher 3", "witcher", "wild", "hunt"
      ]
    },
    "animal crossing: new horizons": {
      keywords: [
        ...
        "isabelle", "nook", "gardening", "turnips", "trading", "2020", "animal crossing", 
    ...
    "call of duty: warzone": {
      keywords: [
        ...
        "call of duty: warzone", "call of duty", "2020", "call", "duty",
        "warzone"
      ]
    },
    "stardew valley": {
      keywords: [
        ...
        "nintendo", "2016", "stardew valley", "stardew", "valley"
      ]
    },
    "among us": {
      keywords: [
    ...
    "plants vs. zombies": {
      keywords: [
        ...
        "garden", "lawnmower", "horde", "waves", "shooting", "app", "potato",
        "ea", "popcap", "2009"
      ]
    },
    "job simulator": {
    ...
    "the last of us": {
      keywords: [
        ...
        "2013", "ps3", "ps4", "cordyceps", "zombies", "infected", "tv adaptation",
        "sony", "fireflies", "soundtrack", "last", "us"
      ]
    }
  };
